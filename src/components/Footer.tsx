...
export function Footer({ onNavigate, onSubscribeNotification }: FooterProps) {
  return (
    <footer className="bg-charcoal text-ivory border-t border-charcoal/80 pt-12 md:pt-16 pb-8 font-sans" id="auranest-footer">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        
        {/* Prominent Full-Width Newsletter Subscription Banner in Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-white/60">
              <li>
                <button onClick={() => onNavigate('home')} className="hover:text-white transition-colors cursor-pointer">Home Studio</button>
              </li>
              <li>
                <button onClick={() => onNavigate('shop')} className="hover:text-white transition-colors cursor-pointer">Shop Catalogue</button>
              </li>
              <li>
                <button onClick={() => onNavigate('about-us')} className="hover:text-white transition-colors cursor-pointer">About Our Brand</button>
              </li>
              <li>
                <button onClick={() => onNavigate('blog')} className="hover:text-white transition-colors cursor-pointer">Interior Journal</button>
              </li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-white/60">
              <li>
                <button onClick={() => onNavigate('faqs')} className="hover:text-white transition-colors cursor-pointer">FAQs & Shipping</button>
              </li>
              <li>
                <button onClick={() => onNavigate('contact-us')} className="hover:text-white transition-colors cursor-pointer">Contact Styling team</button>
              </li>
              <li>
          ...
          {/* Column 4: Quick Newsletter Box (span 3) */}
          <div className="md:col-span-3 space-y-4">
            <h4 className="font-serif text-sm font-semibold uppercase tracking-wider text-white">Quick Subscribe</h4>
            <p className="text-xs text-white/60 leading-relaxed font-sans">
              Enter your email below to quickly subscribe to private collection previews and interior design advice.
            </p>
